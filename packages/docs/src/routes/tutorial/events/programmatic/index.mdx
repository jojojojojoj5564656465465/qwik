...
Qwik provides the following [functions](https://qwik.dev/docs/components/events/#useonwindowdocument-hook) to attach a listener:
...
_for other events like onMouseLeave use mouseleave, for onMouseOut use mouseout without 'on'_
